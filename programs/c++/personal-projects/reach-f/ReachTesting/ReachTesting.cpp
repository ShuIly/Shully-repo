#include "ReachTestingHeader.h"

int main(){

    system("color 3e");

    short x, y, razmer, p = 1 , q = 1 , rnx, c = 6 , j = 7, rnx1, rcx, CoinNumb = 0, MovesTillEnemyTurn = 1, MovesTillReach, Comp = 1, level = 1, s, v;
    char pole[100][100], Move, player = 1 , enemy = 2, swarm, Fpole[100][100];
            ...
            for(y = 0 ; y < razmer ; ++y){
                for(x = 0 ; x < razmer ; ++x){
                    Fpole[x][y] = pole[x][y];
                                          ...
                                          /* where the new enemy move system starts */
